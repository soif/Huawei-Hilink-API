...
This project will let you interface with Huawei routers  easily that support the Hilink XML API. It has been forked from Danish developer Henrik Sylvester Pedersen.

##What can it do?

 - Send SMS through the mobile network
 - Receive SMS (you need to poll for this periodically)
